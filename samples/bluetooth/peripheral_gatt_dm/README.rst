...
The peripheral GATT Discovery sample demonstrates how to use the :ref:`gatt_dm_readme`.

Overview
********

When connected, the sample discovers services of the connected device.
...
#. Observe that the services of the connected device are shown printed in the terminal emulator.
